...
目前市面上比较流行的 n 选 k 不经意传输协议的设计主要基于 RSA 的不经意传输协议，基于椭圆曲线的不经意传输协议，基于 IBE 公钥系统的不经意传输，基于 NTRU 的不经意传输，基于格的不经意传输和基于匿名证书的不经意传输等。本文只对基于 RSA 的不经意传输和基于椭圆曲线的不经意传输算法设计做介绍。
